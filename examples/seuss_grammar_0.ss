...
(define grammar
  '(program
     ((abstraction F223 ()
        (choose
          (elem "elt10" (tr "trans92" (F155))
            (tr "trans91" (F162)))
          (elem "elt10" (tr "trans95" (F152)))
          (elem "elt10" (tr "trans53" (F179))
            (tr "trans52" (F162)))
          (elem "elt10" (tr "trans107" (F179))
            (tr "trans106" (F180)) (tr "trans105" (F8)))
          (elem "elt10" (tr "trans12" (F163))
            (tr "trans11" (F162)) (tr "trans10" (F193)))
          (elem "elt10" (tr "trans53" (F179))
            (tr "trans65" (F194)) (tr "trans64" (F177)))
          (elem "elt10" (tr "trans26" (F155))
            (tr "trans25" (F162)))))
       (abstraction F222 ()
         (choose
           (elem "elt17" (tr "trans102" (F152))
             (tr "trans101" (F174)))
           (elem "elt17" (tr "trans112" (F205))
             (tr "trans111" (F171)) (tr "trans110" (F174)))
           (elem "elt17" (tr "trans34" (F152))
             (tr "trans33" (F171)) (tr "trans32" (F186))
             (tr "trans31" (F191)) (tr "trans30" (F190))
             (tr "trans29" (F146)) (tr "trans28" (F190))
             (tr "trans27" (F193)))
           (elem "elt17" (tr "trans58" (F221))
             (tr "trans55" (F221)) (tr "trans54" (F174))
             (tr "trans51" (F223)) (tr "trans47" (F221)))
           (elem "elt17" (tr "trans70" (F220))
             (tr "trans69" (F144)) (tr "trans66" (F221))
             (tr "trans51" (F223)))
           (elem "elt17" (tr "trans80" (F205))
             (tr "trans79" (F41)) (tr "trans78" (F194))
             (tr "trans77" (F144)))
           (elem "elt17" (tr "trans87" (F152))
             (tr "trans29" (F146)) (tr "trans86" (F190))
             (tr "trans31" (F191)) (tr "trans85" (F182)))))
       (abstraction F221 ()
         (choose
           (elem "elt14" (tr "trans46" (F162))
             (tr "trans45" (F132)) (tr "trans44" (F155)))
           (elem "elt14" (tr "trans57" (F171))
             (tr "trans56" (F171)))
           (elem "elt14" (tr "trans60" (F177))
             (tr "trans59" (F152)))
           (elem "elt14" (tr "trans63" (F222))
             (tr "trans62" (F144)))
           (elem "elt14" (tr "trans68" (F162))
             (tr "trans67" (F181)))
           (elem "elt14" (tr "trans19" (F220))
             (tr "trans18" (F132)))
           (elem "elt14" (tr "trans50" (F181))
             (tr "trans49" (F182)) (tr "trans48" (F171)))))
       (abstraction F220 ()
         (choose (elem "elt9")
           (elem "elt9" (tr "trans9" (F223)))
           (elem "elt9" (tr "trans84" (F222)))))
       (abstraction F219 ()
         (choose
           (elem "elt12" (tr "trans17" (F221))
             (tr "trans16" (F177)) (tr "trans15" (F144))
             (tr "trans14" (F166)))
           (elem "elt12" (tr "trans24" (F223))
             (tr "trans23" (F144)) (tr "trans22" (F132))
             (tr "trans21" (F105)) (tr "trans20" (F186))
             (tr "trans13" (F219)))
           (elem "elt12" (tr "trans24" (F223))
             (tr "trans90" (F132)) (tr "trans89" (F144))
             (tr "trans88" (F144)) (tr "trans83" (F220))
             (tr "trans82" (F193)))
           (elem "elt12" (tr "trans43" (F221))
             (tr "trans42" (F144)) (tr "trans41" (F144))
             (tr "trans36" (F205)) (tr "trans35" (F166)))
           (elem "elt12" (tr "trans100" (F222))
             (tr "trans99" (F220)) (tr "trans98" (F152))
             (tr "trans97" (F186)) (tr "trans96" (F188))
             (tr "trans94" (F223)) (tr "trans93" (F180)))
           (elem "elt12" (tr "trans76" (F222))
             (tr "trans75" (F177)) (tr "trans74" (F144))
             (tr "trans73" (F166)) (tr "trans72" (F162))
             (tr "trans71" (F49)) (tr "trans61" (F221)))))
       (abstraction F205 ()
         (choose
           (elem "elt7" (tr "trans39" (F187))
             (tr "trans81" (F144)))
           (elem "elt7" (tr "trans40" (F144))
             (tr "trans39" (F187)) (tr "trans38" (F86))
             (tr "trans37" (F188)))
           (elem "elt7" (tr "trans113" (F152)))
           (elem "elt7" (tr "trans7" (F132)))))
       (abstraction F195 ()
         (choose
           (elem "elt0" (tr "trans109" (F222))
             (tr "trans108" (F171)) (tr "trans104" (F223))
             (tr "trans103" (F174)))
           (elem "elt0" (tr "trans8" (F220))
             (tr "trans6" (F205)) (tr "trans5" (F144))
             (tr "trans4" (F146)) (tr "trans3" (F163))
             (tr "trans2" (F155)) (tr "trans1" (F162))
             (tr "trans0" (F166)))))
       (abstraction F194 () (choose (elem "elt29")))
       (abstraction F193 () (choose (elem "elt11")))
       (abstraction F191 () (choose (elem "elt19")))
       (abstraction F190 () (choose (elem "elt18")))
       (abstraction F188 () (choose (elem "elt22")))
       (abstraction F187 () (choose (elem "elt24")))
       (abstraction F186 () (choose (elem "elt15")))
       (abstraction F182 () (choose (elem "elt25")))
       (abstraction F181 () (choose (elem "elt26")))
       (abstraction F180 () (choose (elem "elt32")))
       (abstraction F179 () (choose (elem "elt27")))
       (abstraction F177 () (choose (elem "elt13")))
       (abstraction F174 () (choose (elem "elt28")))
       (abstraction F171 () (choose (elem "elt20")))
       (abstraction F166 () (choose (elem "elt1")))
       (abstraction F163 () (choose (elem "elt4")))
       (abstraction F162 () (choose (elem "elt2")))
       (abstraction F155 () (choose (elem "elt3")))
       (abstraction F152 () (choose (elem "elt21")))
       (abstraction F146 () (choose (elem "elt5")))
       (abstraction F144 () (choose (elem "elt6")))
       (abstraction F132 () (choose (elem "elt8")))
     ...
     (lambda ()
       (choose (F195) (F219) (F219) (F219) (F222) (F219)
         (F222) (F219) (F195)))))
(define elements
  '((elt30
...
(define (next-unused-name prefix)
  (if (file-exists?
      ...
      (begin
        (set! scene-counter (+ 1 scene-counter))
        (next-unused-name prefix))
      (string-append prefix (number->string scene-counter))))
(define (sample-once)
  (let* ((filename
          (next-unused-name "seuss_final_01.dae.scene"))
         (final-name (string-append filename ".dae")))
    (begin
      (sample->sxml filename grammar elements transforms)
      (reconstitute "seuss_final_01.dae" filename final-name))))

(define (sample-multiple k)
  (let* ((filename
          (next-unused-name "seuss_final_01.dae.scene"))
         (final-name (string-append filename ".dae")))
    (begin
      (sample->sxml-multiple k filename grammar elements transforms)
      (reconstitute "seuss_final_01.dae" filename final-name))))
