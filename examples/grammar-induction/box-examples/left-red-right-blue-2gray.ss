...
(define merge-history '(
 ...
 ;;     (likelihood+weight -3.295836866004329 1.0)
 ;;     (prior+weight -145.30685281944005 1.0)
 ;;     (desc-length 146) (dirichlet-prior 0.6931471805599456))
 ;;   ())
 ;;  (program
 ;;    ((abstraction F27 () (elem "red" (tr "forward" (F0))))
 ;;      (abstraction F20 () (elem "gray" (tr "forward" (F19))))
 ...
 ;;      (likelihood+weight -3.295836866004329 1.0)
 ;;      (prior+weight -139.30685281944005 1.0)
 ;;      (desc-length 140) (dirichlet-prior 0.6931471805599456))
 ;;    ())
 ;;  (program
 ...
 ;;      (likelihood+weight -3.295836866004329 1.0)
 ;;      (prior+weight -133.30685281944005 1.0)
 ;;      (desc-length 134) (dirichlet-prior 0.6931471805599456))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F29 ()
 ;;       (choose
 ...
 ;;      (likelihood+weight -3.295836866004329 1.0)
 ;;      (prior+weight -129.30685281944005 1.0)
 ;;      (desc-length 130) (dirichlet-prior 0.6931471805599456))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F31 ()
 ;;       (choose (elem "gray" (tr "forward" (F18)))
 ...
 ;;      (likelihood+weight -4.68213122712422 1.0)
 ;;      (prior+weight -128.30685281944005 1.0)
 ;;      (desc-length 129) (dirichlet-prior 0.6931471805599461))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F32 ()
 ;;       (choose (elem "gray" (tr "forward" (F28)))
 ...
 ;;      (likelihood+weight -6.591673732008658 1.0)
 ;;      (prior+weight -126.6137056388801 1.0)
 ;;      (desc-length 128) (dirichlet-prior 1.3862943611198912))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F33 ()
 ;;       (choose (elem "gray" (tr "forward" (F33)))
 ...
 ;;      (likelihood+weight -7.454719949364001 1.0)
 ;;      (prior+weight -120.6137056388801 1.0)
 ;;      (desc-length 122) (dirichlet-prior 1.3862943611198912))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F34 ()
 ;;       (choose (elem "gray" (tr "forward" (F34)))
 ...
 ;;      (likelihood+weight -8.841014310483892 1.0)
 ;;      (prior+weight -119.6137056388801 1.0)
 ;;      (desc-length 121) (dirichlet-prior 1.3862943611198917))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F35 ()
 ;;       (choose (elem "gray" (tr "forward" (F35)))
 ...
 ;;      (likelihood+weight -12.235076682267303 1.0)
 ;;      (prior+weight -102.82194616965205 1.0)
 ;;      (desc-length 106) (dirichlet-prior 3.178053830347948))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F37 ()
 ;;       (choose (elem "gray" (tr "forward" (F23)))
 ...
 ;;      (likelihood+weight -12.999897393843561 1.0)
 ;;      (prior+weight -96.82194616965205 1.0)
 ;;      (desc-length 100) (dirichlet-prior 3.178053830347948))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F38 ()
 ;;       (choose (elem "red" (tr "forward" (F38)))
 ...
 ;;      (likelihood+weight -19.85561569885293 1.0)
 ;;      (prior+weight -53.208240530771945 1.0)
 ;;      (desc-length 55) (dirichlet-prior 1.7917594692280578))
 ;;    ())
 ;;  (program
 ;;    ((abstraction F45 ()
