  ...
  '(program
   ((abstraction F157 ()
      (choose
        ...
        (elem "elt14" (tr "trans63" (F153))
          (tr "trans62" (F122)))
        (elem "elt14" (tr "trans68" (F126))
          (tr "trans67" (F73)))
        (elem "elt14" (tr "trans19" (F155))
          (tr "trans18" (F120)))))
     (abstraction F156 ()
       (choose
         ...
         (elem "elt10" (tr "trans92" (F125))
           (tr "trans91" (F126)))
         (elem "elt10" (tr "trans95" (F0)))
         (elem "elt10" (tr "trans53" (F6))
           (tr "trans52" (F126)))))
     (abstraction F155 ()
       (choose (elem "elt9")
         (elem "elt9" (tr "trans9" (F156)))
         (elem "elt9" (tr "trans84" (F153)))))
     (abstraction F154 ()
       (choose
     ...
     (abstraction F153 ()
       (choose
         ...
         (elem "elt17" (tr "trans34" (F0))
           ...
           (tr "trans27" (F98)))
         (elem "elt17" (tr "trans58" (F157))
           (tr "trans55" (F157)) (tr "trans54" (F3))
           (tr "trans51" (F156)) (tr "trans47" (F157)))
         (elem "elt17" (tr "trans70" (F155))
           (tr "trans69" (F122)) (tr "trans66" (F157))
           (tr "trans51" (F156)))
         (elem "elt17" (tr "trans80" (F154))
     ...
     (abstraction F149 ()
       (choose
         (elem "elt12" (tr "trans17" (F157))
           (tr "trans16" (F63)) (tr "trans15" (F122))
           (tr "trans14" (F127)))
         (elem "elt12" (tr "trans43" (F157))
           (tr "trans42" (F122)) (tr "trans41" (F122))
           (tr "trans36" (F154)) (tr "trans35" (F127)))
         (elem "elt12" (tr "trans100" (F153))
           (tr "trans99" (F155)) (tr "trans98" (F0))
           (tr "trans97" (F17)) (tr "trans96" (F18))
           (tr "trans94" (F156)) (tr "trans93" (F7)))
         (elem "elt12" (tr "trans76" (F153))
           (tr "trans75" (F63)) (tr "trans74" (F122))
           (tr "trans73" (F127)) (tr "trans72" (F126))
           (tr "trans71" (F49)) (tr "trans61" (F157)))
         ...
         (elem "elt12" (tr "trans24" (F156))
           ...
           (tr "trans88" (F122)) (tr "trans83" (F155))
           (tr "trans82" (F98)))))
     (abstraction F132 ()
       (choose
         (elem "elt0" (tr "trans109" (F153))
           (tr "trans108" (F2)) (tr "trans104" (F156))
           (tr "trans103" (F3)))
         (elem "elt0" (tr "trans8" (F155))
           (tr "trans6" (F154)) (tr "trans5" (F122))
   ...
   (lambda ()
     (choose (F132) (F149) (F149) (F149) (F153) (F149)
       (F153) (F149) (F132)))))
(define elements
  '((elt30
